$(document).ready(function() {
    ...
    function displayEvents(response, statusFilter) {
        ...
        const appendMatchDetails = (eventData) => {
            ...
            var matchTime = new Date(eventData.match_timestamp * 1000).toLocaleTimeString([], { hour: '2-digit', minute: '2-digit' });
            matchElement.append($('<div>').addClass('event-time').text(matchTime));
    ...
    $(document).ready(function() {
     initializePreferences();
        ...
        let defaultImageToShow = $('#odds-details').data('target');
